...
public class StudentServlet extends HttpServlet {
    ...
    public void init() throws ServletException {
        ...
        studentList.add(new Student(1, "Tuan ngoc", "12A1", 10));
        studentList.add(new Student(2, "tuan ngoc1", "12A2", 9.5));
        studentList.add(new Student(3, "Tuan Ngoc2", "12A3", 8.0));
        studentList.add(new Student(4, "Tuan ngoc 1", "12A4", 10));
    }
